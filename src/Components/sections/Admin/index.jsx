...
const Admin = () => {
  ...
  useEffect(() => {
    ...
    setUserRole(role.userData.data);
      ...
      <Layout>
        <Header className="header">
          ...
          <div className="welcome_box">
            <img
              src={
                portfolioData?.intro.profile_url
                  ? portfolioData?.intro.profile_url
                  : default_pic
              }
              alt="User Profile"
