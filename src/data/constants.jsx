export const Bio = {
  ...
  description:"I am Full Stack Developer With Knowledge of JavaScript Typescript & Angular Framework And Python Django. To become a successful professional in a highly competitive technological world where performance is rewarded with new challenging responsibilities and to serve a reputed growth-oriented industry in the field of Development.",
